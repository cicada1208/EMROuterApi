namespace Lib.Consts
{
    public class MsgConst
    {
        ...
        public const string DataNeedTypeNum = "需輸入數值。";
        public const string DataDuplication = "資料重複。";
        public const string KeyDuplication = "鍵值重複。";
        public const string QueryDataNone = "查無資料。";
        public const string SaveDataNone = "無儲存資料。";
        public const string ParamNone = "參數未填。";
